...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ url('/') }}" class="brand-link">
      <img src="{{ asset('public/img/logo.jpeg') }}" alt="logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SIG SORONG</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            @endif
              <li class="nav-item">
                  <a href="{{ url('peta') }}" class="nav-link {{ (request()->is('peta')) ? 'active' : '' }}">
                  <i class="nav-icon fas fa-chart-pie"></i>
                  <p>Peta</p>
                  </a>
              </li>
              <li class="nav-item">
                  <a href="{{ url('perguruan-tinggi') }}" class="nav-link {{ (request()->is('perguruan-tinggi')) ? 'active' : '' }}">
