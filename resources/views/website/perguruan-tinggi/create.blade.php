      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form id="form" action="{{ url('perguruan-tinggi-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                <div class="row">
                            ...
                            <div class="form-control-wrap">
                                <div class="fileinput fileinput-new input w-full mt-2" data-provides="fileinput">
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <a href="javascript:;" class="button btn btn-sm btn-danger fileinput-exists" data-dismiss="fileinput">Remove </a>
                                    </div>
                                </div>
                            </div>
                        </div>
